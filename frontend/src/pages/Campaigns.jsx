...
import LocationAutocomplete from '../componants/LocationAutocomplete';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 animate-fade-in-up flex-grow">
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-8">
        <div className="relative flex-grow">
          <FaSearch className="absolute left-4 top-4 text-gray-400 z-10" />
          <LocationAutocomplete 
            placeholder="Search by City (e.g. Mumbai, Delhi)..." 
            value={filters.city}
            onChange={(e) => setFilters(prev => ({ ...prev, city: e.target.value }))}
            className="!pl-12 !pr-4 !py-3.5 !rounded-xl border-gray-200 shadow-sm focus:border-blue-500"
          />
        </div>
        <select 
